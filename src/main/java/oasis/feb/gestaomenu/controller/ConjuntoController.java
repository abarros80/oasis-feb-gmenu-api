...
public class ConjuntoController {
    ...
    @PostMapping
    public ResponseEntity<Conjunto> create(@RequestBody Conjunto obj){
    ...
    @PutMapping("{id}")
    public ResponseEntity<ConjuntoDTO> update(@PathVariable  long id, @RequestBody ConjuntoDTO objDTO) throws NewResourceNotFoundException {
